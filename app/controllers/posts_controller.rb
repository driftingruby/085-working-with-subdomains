class PostsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @post.save
        format.html { redirect_to [current_blog, @post], notice: 'Post was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @post.update(post_params)
        format.html { redirect_to [current_blog, @post], notice: 'Post was successfully updated.' }
